...
#ifndef _MYSTICAL_TYPE_H
#define _MYSTICAL_TYPE_H

#ifndef _MYSTICAL_TYPES_H
#include <sys/types.h>
#endif

/* 虚拟内存块，一个块在INTEL的Mystical中是256个字节 */
typedef unsigned int vir_clicks;
/* 物理地址（字节） */
typedef unsigned long phys_bytes;
/* 物理内存块，一个块在INTEL的Mystical中是256个字节 */
...
/* 消息，Mystical中的进程通信的根本，同时也是客户端和服务端通信的根本
 * 此数据结构来源自MINIX
 */
