#ifndef _MYSTICAL_CONFIG_H
#define _MYSTICAL_CONFIG_H
...
/* 如果在不在32位机器上编译，报错 */
#if _WORD_SIZE != 4
#error 对不起，Mystical暂时只支持32位编译器和32位机器！
#endif
...
#define BOOT_PARAM_MAGIC    0x4D4F   /* 引导参数魔数 */
#define BP_MAGIC            0
#define BP_MEMORY_SIZE      1
#define BP_KERNEL_FILE      2

/* 进程表中的用户进程的槽数，这个配置决定了Mystical能同时运行多少个用户进程。 */
#define NR_PROCS          32
...
#ifndef MACHINE
#error "编译前请在<mystical/config.h>配置文件中定义你要编译的机器的宏(MACHINE)"
#endif
